...
M = dlmread('switch_frequency_app.csv');
app_switch = M(:, 1:5).'
...
set(gcf, 'Color', 'w');
export_fig app_switch_frequency_line_8_6.pdf
...
% set(gcf, 'Color', 'w');
% export_fig app_switch_frequency_line_17_6.pdf
